...
-- Based on this postgraphile GQL query optimized plan:

-- GQL:

-- query GetPaymentAddressSummary($addresses: [String!], $atBlock: Word31Type!) {
--   utxos(
--     where: {
--       _and: {
...
-- select
--   __utxo__."id"::text as "0",
--   __utxo__."value"::text as "1",
--   __utxo__."address" as "2",
--   (not (__utxo__ is null))::text as "3",
--   array(
--     select array[
--       __token_in_output__."assetId"::text,
--       __token_in_output__."quantity"::text,
--       (not (__token_in_output__ is null))::text
--     ]::text[]
--     from "cardano_graphql"."TokenInOutput" as __token_in_output__
--     where (
--       __token_in_output__."tx_out_id" = __utxo__."id"
--     )
--   )::text as "4"
-- from "cardano_graphql"."Utxo" as __utxo__
-- where (
--     (exists(
--       select 1
--       from "cardano_graphql"."Transaction" as __transaction__
--       where (
--         (__utxo__."txHash" = __transaction__."hash")
--       and
--         (exists(
--           select 1
--           from "cardano_graphql"."Block" as __block__
--           where (
--             (__transaction__."blockHash" = __block__."hash")
--           and
--             (__block__."number" <= $1::"public"."word31type")
--           )
--         ))
--       )
--     ))
--   and
--     (__utxo__."address" = ANY($2::"varchar"[]))
-- )
-- order by __utxo__."id" asc;
...
--                 "tokens": [
--                 {
--                     "assetId": "e03fa50b4ecef2b768bfaf43b3a89038aa7f2718319404072967cd42536861726564546f6b656e",
--                     "quantity": "4"
--                 }
--                 ]
--             },
...
--                 "tokens": [
--                 {
--                     "assetId": "1170d12887c70593e40938a5ff1832f9eb2b8e4a328a982621b36a5767632e6469736b",
--                     "quantity": "1"
--                 }
--                 ]
--             },
...
--                 "tokens": [
--                 {
--                     "assetId": "1170d12887c70593e40938a5ff1832f9eb2b8e4a328a982621b36a5774657374",
--                     "quantity": "1"
--                 }
--                 ]
--             },
...
--                 "tokens": [
--                 {
--                     "assetId": "7db93cd34a691292bb3ab73e624042bdbfbca3bf8f1621f26da2e5dc4b65657043616c6d566f746547434653",
--                     "quantity": "1"
--                 }
--                 ]
--             }
